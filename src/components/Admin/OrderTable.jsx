...
const OrderTable = () => {
    ...
    return (
        <>
            <MetaData title="Admin Orders | The Mishra's" />

            {loading && <BackdropLoader />}

            <h1 className="text-lg font-medium ml-5 uppercase">orders</h1>
            <div className="bg-white rounded-xl ml-2 shadow-lg w-full" style={{ height: 470 }}>
